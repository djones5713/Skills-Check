...
//Code Here
var me = {firstName: "Destiny", state:"Maryland", age: 25,greeter: function(){
...
//Loop over the passed in arr param. If the number is GREATER than 100, push 'big' as a string to the answers array. If the number is LESS than or EQUAL to 100, push 'small' as a string to the answers array. Return the answers array inside of the function
// Code here
...
// Code Here
const total = myNumbers.reduce(add,0);
...
const forTheLoveOfGeorge = notGeorge.key(x).map(key => George)
